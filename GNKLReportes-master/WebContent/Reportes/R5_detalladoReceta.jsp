<%@ page language="java" session="true" import="modelo.Brepor5" contentType="text/html; charset=ISO-8859-1"
...
<title>REPORTE 5 REPORTE DETALLADO POR RECETA</title>
</head>
<body onload="ocultarTotales_reporte5()">
	<%if(usuario.getRoll().equals("") || usuario.getUsuario().equals("")){
		response.sendRedirect("../login.jsp");
	} %>
	<a href="../ServletControl?menu=5&caso=1">Regresar al menú</a>
	<br></br>
	<table border="1" id="tbl">
		<thead>
			<tr>
				...
				<th>FECHA</th>
				<th>BENEFICIARIO</th>
				<th>ESPECIFICACION TECNICA MEDICAMENTO/MATERIAL DE CURACIÓN</th>
				<th>PRESENTACION</th>
				<th>ORIGEN</th>
		...
		<tbody>
			<%
				for(int i=0; i<tabla.getTabla().size(); i++){
					Brepor5 aux=(Brepor5)tabla.getTabla().get(i);
					out.println("<tr>");
