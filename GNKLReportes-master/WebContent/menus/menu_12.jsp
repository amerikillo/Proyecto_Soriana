...
<title>12- INCIDENCIA EPIDEMIOLOGICA</title>
</head>
<body onload="ocultaEtiquetas_menu12()">
	...
	<form name="frmMenu12" action="../ServletControl" onsubmit="return validarMenu12()" method="post">
		<input type="hidden" name="caso" value="120" />
