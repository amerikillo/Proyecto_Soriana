...
<title>7- REPORTE RECETADO POR MEDICO</title>
</head>
...
<form name="frmMenu7" action="../ServletControl" onsubmit="return validarMenu7()" method="post">
	<input type="hidden" name="caso" value="70" />
	...
	Médico: 
	<select name="cmbMedico" id="cmbMedico">
		<option value="0">-- Seleccione --</option>
	</select>
