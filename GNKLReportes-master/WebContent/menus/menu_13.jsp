...
<title>13- ATRASO MENSUAL EN ENTREGAS</title>
</head>
<body onload="ocultaEtiquetas_menu13()">
	...
	<form name="frmMenu2" action="../ServletControl" onsubmit="return validarMenu13()" method="post">
		<input type="hidden" name="caso" value="130" />
		...
		<label id="lblFecha" style="color: red;">*</label>
		<br></br>
