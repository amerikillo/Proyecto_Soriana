...
<title>14- REPORTE INSUMOS NO ABASTECIDOS</title>
</head>
<body onload="ocultaEtiquetas()">
	...
	<form name="frmMenu14" action="../ServletControl" onsubmit="return validarMenu2()" method="post">
		<input type="hidden" name="caso" value="140" />
