...
<title>18- REPORTE CONCENTRADO DE FACTURACION</title>
</head>
<body onload="ocultaEtiquetas_menu18()">
	...
	<form name="frmMenu18" action="../ServletControl" onsubmit="return validarMenu18()" method="post">
		<input type="hidden" name="caso" value="180" />
