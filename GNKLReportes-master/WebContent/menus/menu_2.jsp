...
<title>2- CONCENTRADO SALIDAS</title>
</head>
...
<form name="frmMenu2" action="../ServletControl" onsubmit="return validarMenu2()" method="post">
	<input type="hidden" name="caso" value="200" />
	Jurisdicción: <select name="cmbJur" id="cmbJur">
	...
	Municipio: <select name="cmbMunicipio" id="cmbMunicipio">
		<option value="0">-- Seleccione --</option>
	...
	Unidad de Atención: <select name="cmbUnidad" id="cmbUnidad">
		<option value="0">-- Seleccione --</option>
	</select>
	...
	Fecha Inicio: <input type="date" name="dateIni" id="dateIni" />
	<label id="lblFini" style="color: red;">*</label>
	Fecha Fin: <input type="date" name="dateFin" id="dateFin" />
	<label id="lblFfin" style="color: red;">*</label>
	<br></br>
	
	Rango de fechas automatico: <select name="cmbFecha" id="cmbFecha">
		<option value="0">-- Seleccione --</option>
	...
	Programa: <select name="cmbPrograma" id="cmbPrograma">
		<option value="0">-- Seleccione --</option>
		<%
