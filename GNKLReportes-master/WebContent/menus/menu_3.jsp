...
<title>3 COCENTRADO MENSUAL</title>
</head>
<body onload="ocultaEtiquetas_menu3()">
...
<form name="frmMenu3" action="../ServletControl" onsubmit="return validarMenu3()" method="post">
	<input type="hidden" name="caso" value="30" />Jurisdicción:
