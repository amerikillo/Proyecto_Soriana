...
<title>5- REPORTE DETALLADO FOLIO RECIBO</title>
</head>
<body onload="ocultaEtiquetas_menu5()">
	...
	<form name="frmMenu2" action="../ServletControl" onsubmit="return validarMenu5()" method="post">
		<input type="hidden" name="caso" value="50" />
